    ...
    <article className="mb-8 border border-gray-300 rounded-lg overflow-hidden shadow-sm mx-4">
        ...
        <thead>
            <tr className="text-gray-600 border-b border-gray-300">
                ...
                <th className="p-3 text-center font-semibold border-x border-gray-200">Total de Faltas</th>
                <th className="p-3 text-center font-semibold border-x border-gray-200">% de Presença</th>
            </tr>
        </thead>
        <tbody>
            <tr className="border-b border-gray-200">
                <td className="p-3 text-gray-800">Construção de Frontend</td>
                <td className="p-3 text-center border-x border-gray-200">0</td>
                <td className="p-3 text-center border-x border-gray-200">100%</td>
            </tr>
            <tr className="border-b border-gray-200">
